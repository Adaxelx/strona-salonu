...
class Footer extends React.Component{
    ...
    handleScroll = () =>{
        ...
        refs.forEach(ref => {
            if (scrollV - this.footer.current.offsetTop > ref.current.offsetTop - window.innerHeight + ref.current.offsetHeight) {
    ...
    return (
        <footer ref={this.footer}>
            <aside  ref={refs[4]} className='media'><i className="fab fa-instagram"></i></aside>
            <aside ref={refs[3]} className='media'><i className="fab fa-facebook-f"></i></aside>
            <section className='visit'>
                <h3 ref={refs[0]} className='title'><span className='firstLetter'>U</span>mów wizytę</h3>
            ...
            <section className='hours'>
                <h3 ref={refs[1]} className='title'><span className='firstLetter'>G</span>odziny otwarcia</h3>
                <ul>
            ...
            <section className='place'>
                <h3 ref={refs[2]} className='title'><span className='firstLetter'>J</span>ak dojechać?</h3>
